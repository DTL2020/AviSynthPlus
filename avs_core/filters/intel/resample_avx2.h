...
void resize_h_planar_float_avx2_permutex_vstripe_m_ks4(BYTE* dst8, const BYTE* src8, int dst_pitch, int src_pitch, ResamplingProgram* program, int width, int height, int bits_per_pixel); // meander V-scan order
